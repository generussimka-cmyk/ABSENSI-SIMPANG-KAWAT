...
const SPREADSHEET_ID = '1i0sQSdoz3_iLIxb5T5NKC8yHOCOUixbLfEKbAPzdas0';
...
function doGet(e) {
  ...
  return template.evaluate()
    .setTitle('Absensi Simpang Kawat')
    .setXFrameOptionsMode(HtmlService.XFrameOptionsMode.ALLOWALL)
    .addMetaTag('viewport', 'width=device-width, initial-scale=1')
    .setFaviconUrl('https://raw.githubusercontent.com/generussimka-cmyk/Logo/main/ldii-jatim.png');
}
